...
function sortSwaggerOperations(
  ...
  const operationOrder: Record<string, number> = {
    ...
    "get /api/driver/jobs/stream": 38,
    // Worker Application
    "get /api/workers/app-version/check": 39,
    "get /ws/workers": 40,
    "get /api/workers/me/status": 41,
    "get /api/workers/me/assignments/history": 42,
    "get /api/workers/me/earnings/summary": 43,
    "post /api/workers/me/online": 44,
    "post /api/workers/me/offline": 45,
    "post /api/workers/me/break": 46,
    "post /api/workers/me/assignments/{ticketNumber}/accept": 47,
    "post /api/workers/me/assignments/check-in-barcode": 48,
    "get /api/workers/me/products/{productCode}/packages": 49,
    "post /api/workers/me/assignments/tickets/complete": 50,
    "get /api/admin/events": 51,
    // Line
    "post /api/line/webhook": 52,
    "get /api/line/dev": 53,
    "get /api/line/dev/submissions": 54,
    "post /api/line/dev/submissions/{submissionId}/confirm": 55,
    "post /api/line/dev/submissions/{submissionId}/reject": 56,
  };
